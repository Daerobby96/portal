...
<head>
    <meta charset="utf-8">
    <title>Surat Edaran - {{ $surat->nomor_surat }}</title>
    <style>
...
<body>
    ...
    <div class="title-block">
        <div class="title">Surat Edaran</div>
    </div>
    ...
    <div class="content">
        <p>Dengan hormat,</p>
        {!! $surat->isi_surat !!}
        <p style="margin-top: 15px;">Demikian surat edaran ini disampaikan untuk menjadi perhatian dan dilaksanakan dengan sebaik-baiknya.</p>
    </div>
