...
<head>
    <meta charset="utf-8">
    <title>Surat Rekomendasi - {{ $surat->nomor_surat }}</title>
    <style>
...
<body>
    ...
    <div class="content">
        ...
        {!! $surat->isi_surat !!}
        <p style="margin-top: 15px;">Demikian surat rekomendasi ini kami buat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</p>
    </div>
