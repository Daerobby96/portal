...
<head>
    <meta charset="utf-8">
    <title>{{ $surat->jenisSurat->nama }} - {{ $surat->nomor_surat }}</title>
    <style>
...
<body>
    ...
    @php
        // Ambil kop surat dari unit atau fallback ke settings
        $kopPt = $surat->unit ? $surat->unit->getKopSuratForPdf() : \App\Models\Setting::get('kop_surat_pt');
    ...
    <div class="title-block">
        <div class="title">{{ $surat->jenisSurat->nama }}</div>
    </div>
