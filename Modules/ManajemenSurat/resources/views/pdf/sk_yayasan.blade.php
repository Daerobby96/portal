...
<head>
    <meta charset="utf-8">
    <title>Surat Keputusan Yayasan - {{ $sk->nomor_sk }}</title>
    <style>
...
<body>
    ...
    @php
        ...
        $namaYayasan   = \App\Models\Setting::get('nama_yayasan', 'YAYASAN PENYELENGGARA');
    @endphp

    {{-- KOP SURAT --}}
    <div class="kop-surat">
        @if($kopYayasan)
            <img src="{{ public_path('storage/' . $kopYayasan) }}" alt="Kop Surat Yayasan">
        @else
            ...
            <table style="width:100%; padding-bottom:8px; border-bottom: 3px solid #000;">
                <tr>
                    ...
                    <td style="text-align:center; vertical-align:middle; padding:0 10px;">
                        <div style="font-size:11px; font-weight:bold; text-transform:uppercase;">{{ $namaYayasan }}</div>
    ...
    @if($kopYayasan)<hr class="kop-divider">@endif

    {{-- JUDUL SK --}}
    <div class="sk-title-block">
        <div class="sk-title-label">Surat Keputusan</div>
        <div class="sk-label-jenis">Ketua Yayasan</div>
