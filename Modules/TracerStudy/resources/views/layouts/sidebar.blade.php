...
<nav id="sidebar-wrapper" class="sidebar-wrapper border-r border-white/5 shadow-2xl transition-all duration-300">
    ...
    <ul class="sidebar-menu list-unstyled">
        <li>
            <div class="sidebar-heading">Tracer Study</div>
        </li>
        <li class="sidebar-item {{ request()->routeIs('tracer-study.*') ? 'active' : '' }}">
            <a href="{{ route('tracer-study.index') }}" class="sidebar-link" data-title="Data Tracer Study">
                <i class="bi bi-mortarboard"></i><span>Data Tracer Study</span>
            </a>
        </li>
    </ul>
