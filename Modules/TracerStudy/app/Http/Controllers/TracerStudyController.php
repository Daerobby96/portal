...
{
    public function index(AiService $aiService, PpeppService $ppeppService)
    {
        ...
        return view('tracerstudy::tracer-study.index', compact('tracerData', 'stats', 'statusDist', 'aiInsight', 'ppeppData'));
    }
