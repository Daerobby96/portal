...
<nav id="sidebar-wrapper" class="sidebar-wrapper border-r border-white/5 shadow-2xl transition-all duration-300">
    ...
    <ul class="sidebar-menu list-unstyled">
        <li>
            <div class="sidebar-heading">Manajemen Rapat</div>
        </li>
        <li class="sidebar-item {{ request()->routeIs('rapat.index') ? 'active' : '' }}">
            <a href="{{ route('rapat.index') }}" class="sidebar-link" data-title="Daftar Rapat">
                <i class="bi bi-calendar-event"></i><span>Daftar Rapat</span>
            </a>
        </li>
        <li class="sidebar-item {{ request()->routeIs('rapat.create') ? 'active' : '' }}">
            <a href="{{ route('rapat.create') }}" class="sidebar-link" data-title="Buat Rapat Baru">
                <i class="bi bi-plus-circle"></i><span>Buat Rapat Baru</span>
            </a>
        </li>
    </ul>
