...
class KategoriAsetController extends Controller
{
    ...
    {
        $kategoris = KategoriAset::withCount('asets')->orderBy('kode')->get();
        return view('manajemenaset::kategori.index', compact('kategoris'));
    }

    public function create()
    {
        return view('manajemenaset::kategori.create');
    }
    ...
    {
        return view('manajemenaset::kategori.edit', compact('kategoriAset'));
    }
