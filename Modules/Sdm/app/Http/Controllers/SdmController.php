...
use Modules\Sdm\Models\{Presensi, Cuti, Lembur, PenilaianKinerja, SuratTugas};
...
class SdmController extends Controller
{
    public function index()
    {
        $stats = [
            ...
            'avg_nilai_tahun_ini' => PenilaianKinerja::where('tahun', now()->year)->avg('nilai_total'),
        ...
        return view('sdm::index', compact('stats', 'recentCutis', 'recentLemburs', 'recentSuratTugas', 'presensiChart'));
    }
}
