...
use Modules\Spmi\Models\TindakLanjut;
use App\Models\User;
...
class TindakLanjutController extends Controller
{
    ...
    public function show(TindakLanjut $tindakLanjut)
    {
        ...
        return view('spmi::tindak-lanjut.show', compact('tindakLanjut'));
    }
    ...
    public function edit(TindakLanjut $tindakLanjut)
    {
        ...
        return view('spmi::tindak-lanjut.edit', compact('tindakLanjut', 'petugas'));
    }
