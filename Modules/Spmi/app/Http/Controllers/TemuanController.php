...
class TemuanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('spmi::audit.temuan.index', compact('temuans'));
    }
    ...
    public function create(Audit $audit, Request $request)
    {
        ...
        $checklist = null;
        if ($checklistId) {
            $checklist = \Modules\Spmi\Models\Checklist::find($checklistId);
        }
        return view('spmi::audit.temuan.create', compact('audit', 'checklist'));
    }
    ...
    public function show(Audit $audit, Temuan $temuan)
    {
        ...
        return view('spmi::audit.temuan.show', compact('audit', 'temuan'));
    }

    public function edit(Audit $audit, Temuan $temuan)
    {
        return view('spmi::audit.temuan.edit', compact('audit', 'temuan'));
    }
