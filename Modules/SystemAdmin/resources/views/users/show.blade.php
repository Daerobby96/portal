    ...
    <div class="col-lg-4">
        <div class="card card-custom text-center">
            <div class="card-body py-4">
                ...
                <span class="badge bg-{{ $user->hasRole("super_admin") ? "danger" : ($user->hasRole("auditor") ? "primary" : ($user->hasRole("auditee") ? "success" : "secondary")) }} mb-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless detail-table">
                            ...
                            <tr>
                                <th>Role</th>
                                <td>{{ Str::title(str_replace("_", " ", $user->roles->first()?->name ?? "User")) }}</td>
                            </tr>
                            <tr>
                                <th>Terdaftar</th>
