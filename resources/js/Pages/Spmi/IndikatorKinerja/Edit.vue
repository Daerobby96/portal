...
const form = useForm({
    standar_id: props.indikatorKinerja.standar_id,
    kode: props.indikatorKinerja.kode,
    nama: props.indikatorKinerja.nama,
    deskripsi: props.indikatorKinerja.deskripsi || '',
    tipe: props.indikatorKinerja.tipe,
    target: props.indikatorKinerja.target,
    satuan: props.indikatorKinerja.satuan,
    unit_penanggung_jawab: props.indikatorKinerja.unit_penanggung_jawab || '',
    baseline: props.indikatorKinerja.baseline || '',
    is_aktif: Boolean(props.indikatorKinerja.is_aktif),
});

const submit = () => {
    form.put(`/indikator-kinerja/${props.indikatorKinerja.id}`);
};
</script>

<template>
    <AuthenticatedLayout>
        <Head :title="`Edit Indikator: ${indikatorKinerja.kode}`" />
        ...
        <div class="max-w-3xl mx-auto space-y-6">
            <div>
                ...
                <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Edit Indikator Kinerja</h1>
                <p class="text-xs text-slate-500 mt-0.5">Perbarui definisi atau target standar mutu SPMI.</p>
            </div>
