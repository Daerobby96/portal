    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <a href="/siklus-spmi" class="text-xs font-semibold text-indigo-600 hover:text-indigo-700 flex items-center gap-1.5 mb-1.5">
                        <i class="bi bi-arrow-left"></i>
                        Kembali ke Daftar Siklus
                    </a>
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Buat Siklus Mutu Baru</h1>
                    <p class="text-xs text-slate-500 mt-0.5">Definisikan siklus penjaminan mutu PPEPP dan tautkan periode akademik.</p>
                </div>
            </div>
