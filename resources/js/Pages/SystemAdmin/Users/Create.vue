...
<template>
    <AuthenticatedLayout>
        <Head title="Pendaftaran Pengguna Baru" />
            ...
            <div class="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-slate-950/20 border border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-slate-300 mt-1 max-w-xl">
                        Daftarkan data identitas dosen/tendik, alamat email, password, dan penugasan peran hak akses.
                    </p>
                </div>
            </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    >
                        ...
                        <span>{{ form.processing ? 'Menyimpan...' : 'Daftarkan Pengguna' }}</span>
                    </button>
                </div>
            </form>
        </div>
