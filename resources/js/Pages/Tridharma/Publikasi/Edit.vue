<template>
    <AuthenticatedLayout title="Edit Publikasi Ilmiah">
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-black text-slate-900">Edit Data Publikasi Ilmiah</h1>
                    <p class="text-xs text-slate-400 mt-0.5">Perbarui rincian artikel ilmiah, akreditasi SINTA, atau tautan DOI.</p>
                </div>
            </div>
...
const form = reactive({
    judul: props.publikasi.judul || '',
    pegawai_id: props.publikasi.pegawai_id || '',
    prodi_id: props.publikasi.prodi_id || '',
    tahun: props.publikasi.tahun || currentYear,
    jenis: props.publikasi.jenis || 'Jurnal Nasional',
    nama_jurnal_penerbit: props.publikasi.nama_jurnal_penerbit || '',
    volume_nomor: props.publikasi.volume_nomor || '',
    url_tautan: props.publikasi.url_tautan || '',
    tingkat_sinta: props.publikasi.tingkat_sinta || '',
});
...
function submit() {
    ...
    router.put(`/publikasi/${props.publikasi.id}`, form, {
        onFinish: () => {
