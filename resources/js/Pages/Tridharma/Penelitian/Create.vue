<template>
    <AuthenticatedLayout title="Tambah Data Penelitian">
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-black text-slate-900">Tambah Data Penelitian Dosen</h1>
                    <p class="text-xs text-slate-400 mt-0.5">Pencatatan karya riset, skema pendanaan, dan anggota tim peneliti.</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-3xl border border-slate-200/80 shadow-xs p-6 sm:p-7 space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        required
                        rows="3"
                        placeholder="Tuliskan judul lengkap penelitian..."
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            placeholder="Contoh: Mandiri / Hibah Kemdikbud / DIPA Kampus"
                ...
                <!-- Anggota Peneliti -->
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1.5">Anggota Peneliti (Dosen / Mahasiswa)</label>
                    <textarea
                        v-model="form.anggota"
                        rows="2"
                        placeholder="Contoh: Dr. Budi Santoso, M.Kom (Anggota 1); Siti Nurhaliza (Mahasiswa TI)"
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                    ...
                    >
                        ...
                        <span>Simpan Data Penelitian</span>
                    </button>
                </div>
            </form>
        </div>
