            ...
            <div class="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-indigo-950/20 border border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-slate-300 mt-1 max-w-xl leading-relaxed">
                        Definisikan tahun akademik baru, semester tridharma, dan rentang tanggal pelaksanaan semester.
                    </p>
                </div>
            </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    placeholder="Catatan surat keputusan rektorat atau pedoman kalender akademik..."
                ...
                <div class="lg:col-span-4 space-y-6 lg:sticky lg:top-6">
                    <div class="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-3">
                        <h4 class="text-xs font-bold text-slate-900 uppercase tracking-wider flex items-center gap-2">
                            ...
                            <span>Pedoman Kalender Periode</span>
                        </h4>
                        <div class="space-y-2 text-xs text-slate-600 leading-relaxed">
                            <p><strong>Semester Ganjil:</strong> Biasanya dimulai pada bulan September hingga Februari tahun berikutnya.</p>
                            <p><strong>Semester Genap:</strong> Biasanya dimulai pada bulan Maret hingga Agustus tahun berjalan.</p>
                            <p class="text-[11px] text-slate-400">Pengaktifan periode akan secara otomatis mengatur filter default di seluruh modul seperti SPMI, SIAKAD, dan Kepegawaian.</p>
                        </div>
                    </div>
                </div>
