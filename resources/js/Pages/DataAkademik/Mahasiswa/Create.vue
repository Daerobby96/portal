<template>
    <AuthenticatedLayout title="Tambah Mahasiswa">
        <div class="max-w-4xl mx-auto space-y-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-black text-slate-900 tracking-tight">Tambah Mahasiswa Baru</h1>
                    <p class="text-xs text-slate-500 mt-1">Registrasi identitas akademik dan data induk mahasiswa.</p>
                </div>
                <Link
                    href="/mahasiswa"
            ...
            <form @submit.prevent="submit" class="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-xs space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-700 mb-1">Tanggal Kelulusan (Jika Sudah Lulus)</label>
                            <input
