        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="hero-chip mb-4">
                    ...
                    <span class="text-uppercase tracking-wider fw-700">Portal Penjaminan Mutu Digital</span>
                </div>
                <h1 class="hero-title mb-4">
                    Meningkatkan <span class="text-gradient">Integritas</span> & Kinerja Akademik
                </h1>
                ...
                <div class="hero-card-wrapper">
                    <div class="hero-glass-card main-card">
                        <div class="card-header-glass">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="text-white-50 small fw-bold">METRIK REAL-TIME</span>
                            </div>
                    ...
                    <div class="hero-glass-card floating-card-1">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h6 class="text-white mb-0 fw-bold">Disetujui</h6>
                    ...
                    <div class="hero-glass-card floating-card-2">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h6 class="text-white mb-0 fw-bold">Kinerja</h6>
...
<section id="progress" class="py-100 bg-white">
    <div class="container">
        <div class="row align-items-center mb-5" data-aos="fade-up">
            <div class="col-lg-6">
                <h2 class="fw-800 mb-0">Dasbor <span class="text-primary">Informasi Mutu</span></h2>
                ...
                <div class="d-flex flex-column gap-4 h-100">
                    <div class="premium-card p-4 border-0 gradient-primary-card text-white">
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            ...
                            <span class="badge bg-white text-primary">Standar Terbaik</span>
                        </div>
                        @php
...
<section id="survey" class="py-100 bg-light-soft">
    <div class="container">
        <div class="row align-items-center mb-5" data-aos="fade-up">
            <div class="col-lg-6">
                <h5 class="text-primary fw-bold text-uppercase tracking-widest mb-3">Survei & Kepuasan</h5>
                <h2 class="fw-800 mb-0">Umpan Balik <span class="text-primary">Pemangku Kepentingan</span></h2>
            </div>
            <div class="col-lg-6 text-lg-end mt-3 mt-lg-0">
                <div class="d-inline-flex align-items-center bg-white p-3 rounded-4 shadow-sm border">
                    <div class="me-4 text-start">
                        <div class="text-muted smaller fw-bold mb-1">INDEKS KEPUASAN (EDOM)</div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 text-center py-5" data-aos="zoom-in">
                <div class="p-5 bg-white rounded-5 shadow-soft border border-dashed">
                    ...
                    <h5 class="mt-3 text-muted fw-800">Saat ini tidak ada survei publik yang aktif.</h5>
                </div>
            </div>
            @endforelse
        </div>
            ...
            <div class="position-relative z-2">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="{{ route('login') }}" class="btn btn-white btn-lg px-5 text-primary fw-800 hover-lift">
                        Akses Masuk Internal <i class="bi bi-box-arrow-in-right ms-2"></i>
                    </a>
                </div>
            </div>
        </div>
